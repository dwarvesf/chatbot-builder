...
import { Avatar, Skeleton, Typography, useToast } from '@mochi-ui/core'
...
export const AvatarUploader = (props: AvatarUploaderProps) => {
  ...
  const { onSuccess, avatar: avatarProp } = props
  ...
  return (
    <div className="bg-background-surface border border-neutral-outline-border rounded-2xl">
      {isLoading ? (
        <div className="opacity-50 flex w-full h-full p-4 hover:cursor-not-allowed  ">
          <div className="flex flex-row w-full relative items-stretch overflow-hidden rounded gap-4">
            ...
            <div className="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2  hover:cursor-disable ">
              <svg
                aria-hidden="true"
        ...
        <label
          htmlFor="upload"
          className="flex w-full h-full p-4 hover:cursor-pointer"
        >
